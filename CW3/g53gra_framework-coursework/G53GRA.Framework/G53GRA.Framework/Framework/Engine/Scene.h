...
extern int status;	//0 in assembly; 1 in disassembly
//0 = suppressor, 1 = scope, 2 = stock, 3 = magazine
extern bool moving[4];	//true = reject key input, false = allow
//0 = bolt, 1 = trigger, 2 = bullet, 3 = shell
extern bool shooting[4];
